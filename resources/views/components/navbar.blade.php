                ...
                <form class="w-full" method="GET" action="{{ url('/search') }}">
                    <div class="flex bg-[#e9e8e7] border border-gray-3 rounded-[10px] h-auto pl-7 items-center gap-3">
                        ...
                        <svg width="1" height="27" viewBox="0 0 1 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line x1="0.5" y1="0.5" x2="0.500001" y2="26.5" stroke="#ACB5BD" stroke-linecap="round" />
                        </svg>

                        <input type="search" name="search" placeholder="Search on Bidify" class="w-full py-[0.4rem] bg-transparent
