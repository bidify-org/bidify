<x-layout>
    ...
    <div class="container mt-6 mx-auto p-6 border-solid border-2 border-grey rounded-lg">
        ...
        <form class="flex flex-row ml-[4rem] gap-[6rem]"
            method="POST" action="{{ route('auctions.store') }}"
            ...
            @csrf
                <div class="flex flex-col mt-12 w-[36rem] max-w-lg padding: 10px gap-[9rem]">
                    <div>
                        ...
                        <p class="font-body text-1xl text-black">Image format .jpg .jpeg .png and minimum size of 300 x 300px (For optimal image use minimum size of 700 x 700 px)</p>
                    </div>
                    <div>
                        <h3 class="font-body font-bold text-2xl text-black">Product Name</h3>
                        <p class="font-body text-1xl text-black">Make sure the product description includes detailed explanations about your product so that buyers can easily understand and find your product.</p>
                    </div>
                    <div class="mb-[2rem]">
                    ...
                    <div>
                        ...
                        <p class="font-body text-1xl text-black">Set a clear and attractive price in your auction listing to showcase your item's value.</p>
                    </div>
                    <div>
                        <h3 class="font-body font-bold text-2xl text-black">Auction End Date</h3>
                        <p class="font-body text-1xl text-black">Specify a clear and definite end time for your auction to create a sense of urgency and help bidders make timely decisions.</p>
                    </div>
                ...
                <div class="flex flex-col mt-12 w-[50rem] max-w-lg " >
                    ...
                    {{-- <div class="flex flex-col flex-start gap-10 my-15">
                        <div class="flex items-center justify-start w-full">
                            <label for="dropzone-file" class="flex flex-col items-center justify-center w-48 h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white relative">
                                ...
                                <input id="dropzone-file" type="file" class="hidden absolute top-0 left-0 w-full h-full opacity-0" />
                                @error('image')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </label>
