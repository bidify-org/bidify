        ...
        <section class="mt-[35px] grid grid-cols-1 justify-between lg:grid-cols-2 xl:gap-0 gap-10">
            <div class="justify-self-center md:justify-self-start">
                <img src="{{ Storage::url($auction->image_url) }}"
                    class="md:h-[500px] md:w-[500px] h-full w-full object-cover rounded-t-[10px]" alt="" />
                {{-- <img src="/dummy/sell_1.png" class="md:h-[500px] md:w-[500px] h-full w-full object-cover rounded-t-[10px]"
                    alt="" /> --}}
                ...
                <div class="mt-1 flex justify-center gap-10 py-4 px-2 border-gray-3 border rounded-b-[10px]">
                    <button class="flex items-center gap-2">
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <path
                                d="M10.0001 18.0416C9.74175 18.0416 9.49175 18.0083 9.28342 17.9333C6.10008 16.8416 1.04175 12.9666 1.04175 7.24165C1.04175 4.32498 3.40008 1.95831 6.30008 1.95831C7.70842 1.95831 9.02508 2.50831 10.0001 3.49165C10.9751 2.50831 12.2917 1.95831 13.7001 1.95831C16.6001 1.95831 18.9584 4.33331 18.9584 7.24165C18.9584 12.975 13.9001 16.8416 10.7167 17.9333C10.5084 18.0083 10.2584 18.0416 10.0001 18.0416ZM6.30008 3.20831C4.09175 3.20831 2.29175 5.01665 2.29175 7.24165C2.29175 12.9333 7.76675 16.1 9.69175 16.7583C9.84175 16.8083 10.1667 16.8083 10.3167 16.7583C12.2334 16.1 17.7167 12.9416 17.7167 7.24165C17.7167 5.01665 15.9167 3.20831 13.7084 3.20831C12.4417 3.20831 11.2667 3.79998 10.5084 4.82498C10.2751 5.14165 9.74175 5.14165 9.50841 4.82498C8.73341 3.79165 7.56675 3.20831 6.30008 3.20831Z"
                                fill="#5B86AC" />
                        </svg>
                    ...
                    <div class="border-l border-gray-3"></div>
                    ...
                    <button class="flex items-center gap-2">
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M10.8334 9.79164C10.675 9.79164 10.5167 9.7333 10.3917 9.6083C10.15 9.36664 10.15 8.96664 10.3917 8.72497L17.225 1.89164C17.4667 1.64997 17.8667 1.64997 18.1084 1.89164C18.35 2.1333 18.35 2.5333 18.1084 2.77497L11.275 9.6083C11.15 9.7333 10.9917 9.79164 10.8334 9.79164Z"
                                fill="#5B86AC" />
                            <path
                                d="M18.3333 6.29169C17.9916 6.29169 17.7083 6.00835 17.7083 5.66669V2.29169H14.3333C13.9916 2.29169 13.7083 2.00835 13.7083 1.66669C13.7083 1.32502 13.9916 1.04169 14.3333 1.04169H18.3333C18.6749 1.04169 18.9583 1.32502 18.9583 1.66669V5.66669C18.9583 6.00835 18.6749 6.29169 18.3333 6.29169Z"
                                fill="#5B86AC" />
                            <path
                                d="M12.5001 18.9584H7.50008C2.97508 18.9584 1.04175 17.025 1.04175 12.5V7.50002C1.04175 2.97502 2.97508 1.04169 7.50008 1.04169H9.16675C9.50842 1.04169 9.79175 1.32502 9.79175 1.66669C9.79175 2.00835 9.50842 2.29169 9.16675 2.29169H7.50008C3.65841 2.29169 2.29175 3.65835 2.29175 7.50002V12.5C2.29175 16.3417 3.65841 17.7084 7.50008 17.7084H12.5001C16.3417 17.7084 17.7084 16.3417 17.7084 12.5V10.8334C17.7084 10.4917 17.9917 10.2084 18.3334 10.2084C18.6751 10.2084 18.9584 10.4917 18.9584 10.8334V12.5C18.9584 17.025 17.0251 18.9584 12.5001 18.9584Z"
                                fill="#5B86AC" />
                        </svg>
            ...
            <div class="justify-self-center md:justify-self-start font-body w-full sm:mt-0 mt-10">
                        ...
                        @auth()
                            @if (auth()->user()->id !== $auction->seller_id)
                                ...
                                <div class="grid grid-cols-2 gap-5 items-end">
                                    <form action="{{ route('bids.placeBid', $auction->id) }}"
                                        ...
                                        <div
                                            ...
                                            <p class="select-none text-xs text-gray-400">Minimal of 10% from the current
                                                bid:
            ...
            @auth()
                @if (auth()->user()->id === $auction->seller_id && $auction->bids->count() > 0 && $auction->winner_id === null)
            ...
            <div>
                ...
                <div class="flex justify-center flex-col">
                    ...
                    <div class="py-5 px-3 grid grid-cols-4 text-black/50 font-medium">
                        ...
                        <p>Bid Price</p>
                        <p class="sm:block hidden">Date</p>
                    </div>
                    <div class="border-b border-gray-3"></div>
                </div>
                        ...
                        <div class="flex justify-center flex-col">
                            <div class="py-5 px-3 grid grid-cols-4 text-black font-medium">
                                ...
                                @else
                                    ...
                                    <p class="sm:block hidden" title="{{ $bid->created_at }}">
